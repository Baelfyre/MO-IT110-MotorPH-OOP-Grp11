...
=======
            ...
            boolean tooShort = timeOps.isWorkedDurationTooShort(todayEntry);

            // If duration is unusually short, show a clear warning instead of a success-only dialog.
            if (tooShort) {
                JOptionPane.showMessageDialog(
                        this,
                        "Warning: Your recorded work duration for today is unusually short.\n\n"
                        + "If this is incorrect and a DTR correction is needed, please contact your supervisor.",
                        "DTR Review Needed",
                        JOptionPane.WARNING_MESSAGE
                );
            } else {
