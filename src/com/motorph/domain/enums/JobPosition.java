...
public enum JobPosition {
    ...
    IT_OPERATIONS_AND_SYSTEMS("IT Operations and Systems", false, false),
    ...
    PAYROLL_MANAGER("Payroll Manager", true, true),
    PAYROLL_TEAM_LEADER("Payroll Team Leader", true, true),
    PAYROLL_RANK_AND_FILE("Payroll Rank and File", false, false),
    ...
    SALES_AND_MARKETING("Sales & Marketing", false, false),
    SUPPLY_CHAIN_AND_LOGISTICS("Supply Chain and Logistics", false, false),
    CUSTOMER_SERVICE_AND_RELATIONS("Customer Service and Relations", false, false),
