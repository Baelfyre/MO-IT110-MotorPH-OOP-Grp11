...
public class MainDashboard extends javax.swing.JFrame {
    ...
    public MainDashboard(User loggedInUser) {
        ...
        initComponents();
        initCustomLayout();
        customizeSidebar(); // <--- This is where the OOP magic happens
    }
    ...
    private void customizeSidebar() {
        ...
        // Only HR and Admin see the "HR Manage" button
        if (role != Role.HR && role != Role.IT) {
            btnShowHr.setVisible(false);
        }

        // Only Payroll and Admin see "Payroll" button
        if (role != Role.PAYROLL && role != Role.IT) {
            btnShowPayroll.setVisible(false);
        }
        ...
        if (!isASupervisor) {
            btnShowSupervisor.setVisible(false); // Hide if they manage no one
        }
    }
    ...
    private void initComponents() {
        ...
        jButton1.setPreferredSize(new java.awt.Dimension(87, 22));
        ...
        jButton7.setPreferredSize(new java.awt.Dimension(148, 22));
        ...
        jButton9.setPreferredSize(new java.awt.Dimension(122, 22));
        ...
        jButton8.setForeground(new java.awt.Color(47, 35, 58));
        jButton8.setText("Upload");
        jButton8.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(47, 35, 58)));
