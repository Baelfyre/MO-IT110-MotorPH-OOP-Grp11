...
public class LeaveService {
    ...
    public LeaveService(AuditRepository auditRepo) {
     ...
     * @param approver The User of the manager performing the action.
     * @return true if successful, false if unauthorized.
     */
    public boolean approveTimecard(Timecard timecard, User approver) {
     ...
     */
    public void rejectTimecard(Timecard timecard, User approver) {
